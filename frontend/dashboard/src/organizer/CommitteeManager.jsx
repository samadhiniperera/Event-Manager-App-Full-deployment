...
function CommitteeManager() {
  ...
  const loadMembers = async () => {
    try {
      ...
      const response = await fetch(API_BASE_URL + '/api/organizer/committee', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingMember 
        ? `${API_BASE_URL}/api/organizer/committee/${editingMember.member_id}`
        : API_BASE_URL + '/api/organizer/committee';
  ...
  const handleDelete = async (member_id) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/organizer/committee/${member_id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
